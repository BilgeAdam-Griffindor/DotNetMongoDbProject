...
namespace DemoMarketPlace.WebApi.DAL.Concrete
{
    public class AddressDAL : IAddressDAL
    {
        ...
        public async Task<List<AddressListDTO>> GetAllAddresses()
        {
            ...
            {
                AddressListDTO adres = new AddressListDTO(address.AddressId, address.AddressName, address.TopAddressId, address.AddressType);
        ...
        public async Task<List<AddressListDTO>> GetAllAddressesFromMongo()
        {
            ...
            {
                AddressListDTO addresses = new AddressListDTO(item.AddressId, item.AddressName, item.TopAddressId, item.AddressType);
