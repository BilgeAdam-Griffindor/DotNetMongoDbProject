...
{
    public partial class DMP_1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopAddressId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_Addresses_TopAddressId",
                        column: x => x.TopAddressId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_TopAddressId",
                table: "Addresses",
                column: "TopAddressId");
